...
function App() {
    ...
    const login = (username: string, password: string, onStart:()=>void, onFail:(error:string)=>void, onSuccess:()=>void) => {
        onStart();
    ...
    return <div className='App'>
        <Router>
            <Switch>
                <PrivateRoute isLoggedin={isLoggedin} component={MainPage} exact path="/" />
